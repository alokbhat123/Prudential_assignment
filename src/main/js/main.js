...
var weatherForecast = (() => {
    ...
    var init = () => {
        ...
        function cb() {
            htmlModule.drawHighChart('splineChart', 'areaspline', '<u>Mumbai Weather Forecast (5 Days)</u>');
                ...
                let secondaryXAxis = {
                    ...
                    labels: {
                        ...
                        formatter: function () {
                            ...
                            return '<img class="img" src="src/resources/css/images/Cloud-Rain.svg"><img>&nbsp;';
                        }
                    },
                    offset: -360
                }
        ...
        var getData = (key) => {
            ...
            $.each(_data, function (k, v) {
                ...
                if (!year[moment(date).date()]) {
                    console.log(v)
                    temp.push({ "clouds": v[c.clouds], "x": convertedDate, "y": v[c[key]], "marker": {}, "details": v });
    ...
    var utilitiesModule = (() => {
        ...
        var imageMap = {
            "tempDeg": {
                ...
                "warm": "src/resources/css/images/Sunrise.svg",
                "cold": "src/resources/css/images/Cloud-Snow.svg"
            },
            "clouds": {
                "raining": "src/resources/css/images/Cloud-Rain.svg",
                "snowing": "src/resources/css/images/Cloud-Snow.svg",
                "sun": "src/resources/css/images/Cloud-Sun.svg"
            }
        }
